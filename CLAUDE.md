...
- **P0-6** — Split payments con Mercado Pago Marketplace (modo piloto) implementado, pausado por el usuario: falta reconocimiento facial de la cuenta de Mercado Pago Developers + cargar `MP_CLIENT_ID`/`MP_CLIENT_SECRET` como secrets.
